...
function presionTecla(e) {
	...
	conexion1.open('GET', '../moduloprofesores/modelos/buscar_profesores_ajax.php?login=' + document.form1.login.value + "&radio1=" + document.form1.radio1.checked + "&radio2=" + document.form1.radio2.checked + "&criterio_ord=" + document.form1.criterio_ord.value + "&mas=" + document.form1.mas.value, true);
	conexion1.send(null);
}
