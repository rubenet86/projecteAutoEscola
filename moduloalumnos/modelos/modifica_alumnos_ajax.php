		...
		$cadena.= '<br>';$cadena.= '<br>';$cadena.= '<br>';$cadena.= '<br>';
			...
			while ($obj = $resultado->fetch_object()){
				...
				$cadena.='<tr>';
					...
					$cadena.='<td align="center"><input type="text" name="password" size="13" value='.$obj->password.'  onkeyup="valida_coche(this)"></td>';
					$cadena.='<td align="center"><input type="text" name="nombre" size="13" value='.$obj->nombre.' onkeyup="valida_coche(this)"></td>';
					$cadena.='<td align="center"><input type="text" name="apellido" size="13" value='.$obj->apellido.' onkeyup="valida_coche(this)"></td>';
					$cadena.='<td align="center"><input type="text" name="dni" size="13" value='.$obj->dni.' onkeyup="valida_coche(this)"></td>';
					$cadena.='<td align="center"><input type="text" name="email" size="13" value='.$obj->email.' onkeyup="valida_coche(this)"></td>';
					$cadena.='<td align="center"><input type="text" name="telefono" size="13" value='.$obj->telefono.' onkeyup="valida_coche(this)"></td>';
					$cadena.='<td align="center"><input type="text" name="sexo" size="13" value='.$obj->sexo.' onkeyup="valida_coche(this)"></td>'; 
				$cadena.='</tr>';
			} 
			$cadena.='</table>';
