...
function presionTecla(e) {
	...
	conexion1.open('GET', '../moduloalumnos/modelos/modifica_alumnos_ajax.php?text=' + document.form3.buscar.value + "&radio1=" + document.form3.radio1.checked + "&radio2=" + document.form3.radio2.checked + "&criterio_ord=" + document.form3.criterio_ord.value, true);
	conexion1.send(null);
}
