...
function presionTecla(e) {
	...
	conexion1.open('GET', '../modulopracticas/modelos/buscar_practicas_ajax.php?numPractica=' + document.form1.numPractica.value + "&radio1=" + document.form1.radio1.checked + "&radio2=" + document.form1.radio2.checked + "&criterio_ord=" + document.form1.criterio_ord.value, true);
	conexion1.send(null);
}
