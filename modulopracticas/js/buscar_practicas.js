...
function presionTecla(e){
  ...
  conexion1.open('GET','../modulopracticas/modelos/buscar_practicas_ajax.php?numPractica='+document.form1.numPractica.value+"&radio1="+document.form1.radio1.checked+
