...
<head>
	...
	<script language="javascript" src="../modulocoches/js/modificar_coches.js" type="text/javascript"></script>
	<script language="javascript" src="../javascript/validar_coches.js" type="text/javascript"></script>
</head>
<body>
...
<table width="92%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	  ...
	  Matricula: <input name="buscar" type="text" id="buscar" autocomplete="off"/></label></td>
    </tr>
	<tr><td>&nbsp;</td></tr>
    <tr>
