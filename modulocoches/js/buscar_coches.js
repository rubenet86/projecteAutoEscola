...
function presionTecla(e) {
	...
	conexion1.open('GET', '../modulocoches/modelos/buscar_coches_ajax.php?matricula=' + document.form1.matricula.value + "&radio1=" + document.form1.radio1.checked + "&radio2=" + document.form1.radio2.checked + "&criterio_ord=" + document.form1.criterio_ord.value, true);
	conexion1.send(null);
}
