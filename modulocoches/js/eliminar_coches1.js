...
function elimina() {
	if (searchReq.readyState == 4 || searchReq.readyState == 0) {
		...
		searchReq.open("GET", '../modulocoches/modelos/eliminar_coches_ajax1.php?txtSearch=' + txtSearch, true);
		searchReq.onreadystatechange = handleSearchSuggest1; 
		searchReq.send(null);
		alert("El coche con matricula: "+txtSearch+" a sido eliminado!");
		document.getElementById('txtSearch').value="";
		
	}
	//window.location.href="../modulocoches/vistas/listar.php";
